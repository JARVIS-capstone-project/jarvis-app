...
/**
 * The /register screen. Mirrors LoginPage exactly so the HUD chrome is a
 * single consistent identity flow — same status bar arrival, same card
 * mount, same watermark. Only the inner form differs.
 */
